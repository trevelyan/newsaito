...
console.log("SPAMMER ON NEW BLOCK");
  ...
  var size_of_emails_in_mb = 0.00001;
...
console.log("A: " + available_inputs_limit + " -- " + available_inputs);
console.log("A: " + this.app.wallet.returnBalance());

    if (available_inputs.lt(available_inputs_limit) || (x > 0 && x >= emails_to_send-1)) { 
      return; 
    }
...
console.log("D new tx: " + JSON.stringify(newtx));
