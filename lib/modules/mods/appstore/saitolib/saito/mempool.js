...
Mempool.prototype.addTransaction = async function addTransaction(tx, relay_on_validate=0) {
  ...
  //
  if (this.containsTransaction(tx) == 1) { console.log("failure 1"); return; }
  if (tx == null)                        { console.log("failure 2"); return; }
  if (tx.transaction == null)            { console.log("failure 3"); return; }
  if (tx.is_valid == 0)                  { console.log("failure 4"); return; }
  ...
  if (transaction_imported == 0) {
    ...
    //
console.log("tx import pre validate?"); 
    if (tx.validate(this.app, null)) {
console.log("tx import validated!"); 
