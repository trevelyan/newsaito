...
Mempool.prototype.fetchBlock = function fetchBlock(peer, bhash) {
  ...
  // avoid dupes
  //
console.log("DOWNLOADING fetchblock 1");
  for (let i = 0; i < this.downloads.length; i++) {
    if (this.downloads[i].bhash == bhash) { return; }
  }
console.log("DOWNLOADING fetchblock 2");
  if (this.app.blockchain.isHashIndexed(bhash) == 1) {
    return;
  }
console.log("DOWNLOADING fetchblock 3");
...
console.log("PUSHED TO DL QUEUE");
console.log(bhash);
...
console.log("LOOP 2-2");
        return;
      }
console.log("LOOP 2-3");
      this.downloading_active = 1;
console.log("LOOP 2-4");
...
console.log("LOOP 3: " + this.block_size_current + " -- " + this.block_size_cap);
...
console.log("LOOP 5");
          let block_to_download_url = block_to_download.peer.peer.protocol + "://" +
				      ...
				      url_sync_pkey;
console.log(block_to_download_url);
          //
          // servers
          //
...
console.log("DOWNLOADING WITH AJAX...");
