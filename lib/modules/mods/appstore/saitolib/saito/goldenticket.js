...
GoldenTicket.prototype.validateSolution = function validateSolution(blk, publickey) {

  //
  // return 1;
  //
console.log("NOT BOTHERING TO VALIDATE THE GT SOLUTION...");
  return 1;
...
console.log("HERE WE ARE FINDING LAST BLOCK: ");
