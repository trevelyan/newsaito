 ...
 **/
Network.prototype.propagateTransaction = function propagateTransaction(tx, outbound_message="transaction") {
...
console.log("propagating tx - adding to mempool");
...
console.log("propagating tx - just adding to mempool");
        this.app.mempool.addTransaction(tx);
      }
    }
  }

console.log("propagating tx - in the middle");
...
console.log("propagating tx - in the middle 1");
    ...
    if (! this.peers[i].inTransactionPath(tx) ) {
      ...
      //
console.log("propagating tx - in the middle 2");
...
console.log("propagating tx - in the middle 3");
      ...
      // if (mycallback == null) {
console.log("propagating tx - in the middle 4");
      this.peers[i].sendRequest(outbound_message, JSON.stringify(tmptx.transaction));
console.log("propagating tx - in the middle 5");
      // } else {
