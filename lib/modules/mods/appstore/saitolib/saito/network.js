...
Network.prototype.propagateBlock = function propagateBlock(blk) {
  ...
  console.log("\n\n\nWE ARE READY TO PROPAGATE A BLOCK\n\n\n");
...
Network.prototype.propagateGoldenTicket = function propagateGoldenTicket(tx) {
  ...
  console.log("\n\n\nWE ARE READY TO PROPAGATE A TRANSACTION\n\n\n");
 ...
 *
 * @params {saito.transaction} transaction
 **/
...
console.log("Bundling Fees: " + this.app.mempool.returnBundlingFeesNeeded());
console.log("TX usable: " + tx.returnFeesUsable(this.app, this.app.wallet.returnPublicKey()));
