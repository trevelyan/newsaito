...
console.log("I AM SENDING A HANDSHAKE....");
...
console.log("a sending blockchain from: " + last_shared_bid);
...
console.log("missing block sending blockchain from: " + last_shared_bid);
...
console.log("BLOCK NOTIFICATION: " + message.data.bid + "  (" + message.data.bhash + ")");
