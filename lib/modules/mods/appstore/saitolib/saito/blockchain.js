  ...
  if (i_am_the_longest_chain == 1 && this.index.hash.length > 1) {
    ...
    if (this.lowest_acceptable_bid == newblock.block.id-1) {
	  ...
	  if (this.index.hash[h] == newblock.block.prevhash) { location_of_last_block = h; }
        ...
        if (is_there_another_lc_at_this_bid == 0) {
	  if (this.index.lc[location_of_last_block] == 0) {
            this.index.lc[location_of_last_block] = 1;
            this.app.storage.onChainReorganization(this.index.block_id[location_of_last_block], this.index.hash[location_of_last_block], 1);
            this.app.wallet.onChainReorganization(this.index.block_id[location_of_last_block], this.index.hash[location_of_last_block], 1);
            this.app.modules.onChainReorganization(this.index.block_id[location_of_last_block], this.index.hash[location_of_last_block], 1);
	  }
	}
      }
    }
