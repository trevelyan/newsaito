...
Mempool.prototype.containsTransaction = function containsTransaction({ transaction: { sig } }) {
...
Mempool.prototype.removeTransaction = function removeTransaction({ transaction: { sig } }) {
...
Mempool.prototype.addTransaction = function addTransaction(tx, relay_on_validate=true) {
  ...
  if (this.containsTransaction(tx) == true) { return; }
  ...
  if (tx.transaction.gt != null) {
    if (gt in this.transactions_hash) {
      var { gtx } = this.transactions_hash.gt
