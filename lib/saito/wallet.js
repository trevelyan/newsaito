...
console.log("AVAIL: " + wallet_avail.toFixed(8));
console.log("TOTAL FEES: " + total_fees.toFixed(8));

  if (total_fees.gt(wallet_avail)) {
console.log("RETURNING SOMETHING UNWORKABLE...");
    return null;
  }

console.log("We should have something OK now...");
...
console.log("ABOUT TO FIND ADEQUATE INPUTS");
console.log(JSON.stringify(this.wallet.spends));
console.log(JSON.stringify(this.wallet.inputs));
