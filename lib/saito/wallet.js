...
// functions that were individually called, but it is no problem logically
// to run them all every time there is a chain reorganization.
//
 ...
 */
Wallet.prototype.processPayment = function processPayment(blk, to_slips, from_slips, lchain) {
...
//
// NO GOLDEN TICKETS YET -- we DO NOT KNOW
//

      var s       = new saito.slip(slips.to[m].add, slips.to[m].amt, slips[m].type);
	  s.ft    = slips[m].ft;
