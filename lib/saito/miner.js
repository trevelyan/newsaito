...
Miner.prototype.attemptSolution = function attemptSolution(prevblk) {
  ...
  //console.log(hashValue.toString().slice(0,6));
  //console.log("DIFF Order: " + difficultyOrder + " --- " + th + " / " + ph);
  //console.log("DIFF GRAIN: " + difficultyGrain + " --- " + th + " / " + ph);
  //if (1) {
  console.log("Mining Result Difference: " + (th-ph));
  if (th >= ph && (th-ph)/16 <= difficultyGrain) {
    console.log("we have a mining solution");
    this.stopMining();
