...
function Transaction(txjson="") {
  ...
  if (txjson != "") {
    try {
      ...
      if (txobj.id != undefined)   { this.transaction.id   = txobj.id; }
      if (txobj.ts != undefined)   { this.transaction.ts   = txobj.ts; }
      if (txobj.from != undefined) { this.transaction.from = txobj.from; }
      if (txobj.to != undefined)   { this.transaction.to   = txobj.to; }
      if (txobj.sig != undefined)  { this.transaction.sig  = txobj.sig; }
      if (txobj.msig != undefined) { this.transaction.msig = txobj.msig; }
      if (txobj.ver != undefined)  { this.transaction.ver  = txobj.ver; }
      if (txobj.path != undefined) { this.transaction.path = txobj.path; }
      if (txobj.type != undefined) { this.transaction.type = txobj.type; }
      if (txobj.msg != undefined)  { this.transaction.msg  = txobj.msg; }
      if (txobj.ps != undefined)   { this.transaction.ps   = txobj.ps; }
...
console.log("PATH: " + this.transaction.path);
