...
/** 
 * returns the fees available from this transaction to the publickey address
 *
 * @returns {string} value
 **/
Transaction.prototype.returnAvailableFees = function returnAvailableFees(publickey) {
