...
console.log("FETCHING BLOCK BY PREVHASH: " + this.block.prevhash);
...
console.log(JSON.stringify(prevblk.block));
console.log(this.block.ts + " ----> " + prevblk.block.ts);
...
console.log("Elapsed Time: " + (this.block.ts - prevblk.block.ts));
console.log(burn_fee_needed.toFixed(8) + " -- " + credits_available.toFixed(8) + " -- " + surplus_available.toFixed(8));
