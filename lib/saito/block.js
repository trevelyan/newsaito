...
console.log("A: " + JSON.stringify(feetx));
...
console.log(JSON.stringify(feetx));
...
Block.prototype.returnFeeTransaction = function returnFeeTransaction() {
console.log("LOOKING FOR FT: " + this.transactions.length);
console.log("LOOKING FOR FT: " + JSON.stringify(this.transactions));
  for (let i = 0; i < this.transactions.length; i++) {
    if (this.transactions[i].transaction.type == 2) {
console.log("FOUND TYPE TWO: " + i);
