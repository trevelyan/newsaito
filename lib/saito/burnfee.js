...
console.log("this block ts: " + blk.block.ts);  
...
console.log(JSON.stringify(prevblk));
console.log("prev block ts: " + prevblk.block.ts);  

  let elapsed_time = blk.block.ts - prevblk.block.ts;
  return this.returnBurnFeeNeeded(prevblk, elapsed_time);
