...
Blockchain.prototype.addBlockToBlockchain = async function addBlockToBlockchain(newblock=null, force=false) {
  ...
  if (i_am_the_longest_chain == 1) {
    ...
    // this.app.storage.onChainReorganization(newblock.block.id, newblock.returnHash(), i_am_the_longest_chain);
    // this.app.wallet.reorganizeTransactionsAtBlockId(newblock.block.id, 0);
    ...
    this.app.blockchain.index.lc[pos] = i_am_the_longest_chain;
