...
console.log("IDENTIFIED LONGEST CHAIN: " + newblock.block.id);
...
//console.log("DO WE HAVE A SHARED ANCESTOR POS? " + shared_ancestor_pos);
...
console.log("SHARED ANCESTOR POS: " + shared_ancestor_pos + " --> lc? " + i_am_the_longest_chain);
  ...
  /////////////////////////////////
  //
  // the first block does directly to addBlockToBlockchainSuccess
  ...
  //
    ...
    if (block_validates == 1) {
      ...
      if (current_wind_index == new_block_idxs.length-1) {
        ...
        await this.windChain(newblock, pos, shared_ancestor_pos, new_block_idxs, new_block_hashes, new_block_ids, old_block_idxs, old_block_hashes, old_block_ids, i_am_the_longest_chain, force, current_wind_index+1, resetting_flag);
        return;
      }
