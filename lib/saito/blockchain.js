...
console.log("ADDING OUR INDEX AT: " + pos);
  ...
  if (i_am_the_longest_chain == 1) {
    ...
    //
    // this is where we break to the subsequent function
    //
 ...
 */
Blockchain.prototype.addBlockToBlockchainSuccess = function addBlockToBlockchainSuccess(newblock, pos, i_am_the_longest_chain, force) {
  return 1;
};
